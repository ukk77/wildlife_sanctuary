...
<form action="#" class ="login">
  ...
  <main class="mdl-layout__content">
	...
	<CENTER><img class = "image" src = "http://www.merukatours.com/images/map/small/north_india.jpg"><br><br>
	<!-- Raised button -->
<button class="mdl-button mdl-js-button mdl-button--raised">
   <a class="mdl-navigation__link" href="North_Zone_Parks.php">Book a Trip</a>
</button>
</CENTER>
	</div>
<footer class="footer">
