...
<form action="#" class ="login">
  ...
  <main class="mdl-layout__content">
	...
	<img class = "image" src = "http://www.emapsworld.com/images/india-central-zone-map.gif"><br><br>
	
	<!-- Raised button -->
<button class="mdl-button mdl-js-button mdl-button--raised" >
  <a class="mdl-navigation__link" href="Central_Zone_Parks.php">Book a Trip</a> 
</button>
</CENTER>
	</div>
<footer class="footer">
