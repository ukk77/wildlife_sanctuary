...
<form action="#" class ="login">
  ...
  <main class="mdl-layout__content">
	...
	<CENTER><img class = "image" src = "https://hotwheels4.files.wordpress.com/2014/11/south-india-map.jpg"><br><br>
	<!-- Raised button -->
<button class="mdl-button mdl-js-button mdl-button--raised">
  <a class="mdl-navigation__link" href="South_Zone_Parks.php">Book a Trip</a>
</button>
</CENTER>
	</div>
<footer class="footer">
